...
- [sparkdantic](https://github.com/mitchelllisle/sparkdantic) 🌟(130) - A library that converts Pydantic models to PySpark schemas (StructType), facilitating schema validation in PySpark pipelines.
...
- [Strawberry GraphQL](https://github.com/strawberry-graphql/strawberry) 🌟(4704) - Python GraphQL library based on dataclasses.
...
- [turms](https://github.com/jhnnsrs/turms) 🌟(77) - GraphQL code generator that generates pydantic models from GraphQL documents
